...
func (pos *Position) MakeNullMove(res *Position) {
	...
	res.Flags = pos.Flags
	res.Key = pos.Key ^ zobristColor ^ zobristEpSquare[pos.EpSquare] ^ zobristFifty[res.FiftyMove&31] ^ zobristFifty[(res.FiftyMove+1)&31]
...
func (pos *Position) MakeMove(move Move, res *Position) bool {
	...
	res.Flags = pos.Flags
	res.Key = pos.Key ^ zobristColor ^ zobristEpSquare[pos.EpSquare] ^ zobristFlags[pos.Flags] ^ zobristFifty[res.FiftyMove&31]
	res.PawnKey = pos.PawnKey ^ zobristColor
	...
	res.Key ^= zobristFifty[res.FiftyMove&31]
...
func (pos *Position) MakeLegalMove(move Move, res *Position) {
	...
	res.SideToMove = pos.SideToMove
	res.Flags = pos.Flags
	res.Key = pos.Key ^ zobristColor ^ zobristEpSquare[pos.EpSquare] ^ zobristFlags[pos.Flags] ^ zobristFifty[pos.FiftyMove&31]
	res.PawnKey = pos.PawnKey ^ zobristColor
