...
var BishopValue = Score{714, 745}
var RookValue = Score{1009, 1193}
var QueenValue = Score{2249, 2324}
...
var pieceScores = [7][8][4]Score{
	...
	{},
	{ // knight
		{Score{-137, -43}, Score{-37, -91}, Score{-83, -60}, Score{-31, -44}},
		{Score{-50, -100}, Score{-71, -67}, Score{-36, -60}, Score{-10, -49}},
		{Score{-54, -70}, Score{-17, -59}, Score{-10, -41}, Score{-14, -5}},
		{Score{-26, -50}, Score{31, -47}, Score{13, 1}, Score{16, 6}},
		{Score{26, -74}, Score{12, -32}, Score{43, 3}, Score{59, 7}},
		{Score{-44, -99}, Score{95, -95}, Score{29, -17}, Score{93, -27}},
		{Score{-112, -88}, Score{-74, -46}, Score{74, -90}, Score{-11, -38}},
		{Score{-298, -108}, Score{-76, -132}, Score{-147, -78}, Score{0, -93}},
	},
	{ // Bishop
		{Score{-23, -23}, Score{4, -21}, Score{7, -20}, Score{-1, -8}},
		{Score{3, -55}, Score{55, -59}, Score{31, -36}, Score{8, -17}},
		{Score{5, -38}, Score{38, -29}, Score{45, -14}, Score{16, 6}},
		{Score{2, -37}, Score{7, -26}, Score{5, 0}, Score{55, 1}},
		{Score{-9, -27}, Score{-6, -17}, Score{35, -8}, Score{65, 1}},
		{Score{-55, -8}, Score{18, -26}, Score{47, -18}, Score{12, -16}},
		{Score{-93, -16}, Score{26, -25}, Score{-15, -13}, Score{-2, -33}},
		{Score{-23, -41}, Score{-35, -41}, Score{-95, -33}, Score{-89, -26}},
	},
	{ // Rook
		{Score{-20, -32}, Score{-33, -9}, Score{9, -23}, Score{22, -32}},
		{Score{-87, 0}, Score{-14, -35}, Score{-30, -19}, Score{-1, -26}},
		{Score{-73, -11}, Score{-27, -17}, Score{-26, -22}, Score{-17, -29}},
		{Score{-62, 3}, Score{-21, 0}, Score{-31, 3}, Score{-20, -5}},
		{Score{-39, 10}, Score{-34, 4}, Score{22, 7}, Score{12, -7}},
		{Score{-41, 13}, Score{36, 4}, Score{40, -4}, Score{25, -3}},
		{Score{35, 12}, Score{9, 24}, Score{77, 4}, Score{96, -9}},
		{Score{7, 18}, Score{14, 14}, Score{-39, 30}, Score{21, 18}},
	},
	{ // Queen
		{Score{-13, -102}, Score{1, -89}, Score{8, -109}, Score{42, -137}},
		{Score{-7, -105}, Score{-2, -79}, Score{51, -113}, Score{29, -71}},
		{Score{0, -45}, Score{32, -54}, Score{-3, 7}, Score{-6, -5}},
		{Score{2, -31}, Score{-18, 35}, Score{-14, 38}, Score{-34, 75}},
		{Score{-5, 0}, Score{-38, 49}, Score{-21, 41}, Score{-47, 105}},
		{Score{42, -43}, Score{21, -17}, Score{18, 20}, Score{3, 76}},
		{Score{0, -45}, Score{-86, 29}, Score{0, 15}, Score{-33, 86}},
	...
	{ // King
		...
		{Score{27, 101}, Score{119, 138}, Score{63, 187}, Score{0, 207}},
		{Score{5, 129}, Score{128, 185}, Score{106, 198}, Score{2, 208}},
		{Score{119, 139}, Score{83, 216}, Score{114, 213}, Score{5, 184}},
		{Score{73, 133}, Score{33, 185}, Score{40, 206}, Score{26, 187}},
		{Score{51, 0}, Score{21, 99}, Score{2, 124}, Score{0, 95}},
	},
}
var pawnScores = [7][8]Score{
	{},
	{Score{-13, -11}, Score{39, -17}, Score{18, 8}, Score{38, 3}, Score{38, 8}, Score{22, 6}, Score{36, -8}, Score{-13, -18}},
	...
	{Score{-20, 22}, Score{19, -2}, Score{9, -15}, Score{52, -30}, Score{50, -39}, Score{4, -6}, Score{21, -7}, Score{-19, 19}},
	{Score{2, 71}, Score{27, 57}, Score{59, 6}, Score{54, -4}, Score{70, -25}, Score{88, 18}, Score{7, 57}, Score{8, 79}},
	{Score{0, 158}, Score{4, 137}, Score{-1, 84}, Score{0, 72}, Score{23, 101}, Score{-26, 108}, Score{0, 123}, Score{-61, 198}},
}

var pawnsConnected = [8][4]Score{
	{Score{0, 0}, Score{0, 0}, Score{0, 0}, Score{0, 0}},
	{Score{8, -29}, Score{17, 4}, Score{17, -7}, Score{9, 26}},
	{Score{13, 3}, Score{57, -3}, Score{18, 8}, Score{44, 30}},
	{Score{32, 1}, Score{44, 5}, Score{30, 14}, Score{47, 10}},
	{Score{25, 20}, Score{25, 24}, Score{44, 36}, Score{52, 30}},
	{Score{0, 89}, Score{53, 76}, Score{89, 83}, Score{133, 44}},
	{Score{-1, 261}, Score{128, 7}, Score{151, 0}, Score{0, 47}},
	{Score{0, 0}, Score{0, 0}, Score{0, 0}, Score{0, 0}},
}

var mobilityBonus = [...][32]Score{
	{Score{-77, -192}, Score{-57, -138}, Score{-37, -82}, Score{-38, -43}, Score{-13, -37}, Score{3, -14}, // Knights
		Score{21, -24}, Score{39, -22}, Score{62, -50}},
	{Score{-60, -167}, Score{-30, -122}, Score{8, -63}, Score{14, -20}, Score{34, -2}, Score{54, 15}, // Bishops
		Score{65, 23}, Score{71, 29}, Score{76, 35}, Score{80, 32}, Score{96, 17}, Score{133, 16},
		Score{89, 41}, Score{76, 21}},
	{Score{-47, -70}, Score{-58, -65}, Score{-34, 1}, Score{-22, 45}, Score{-12, 77}, Score{-9, 100}, // Rooks
		Score{2, 118}, Score{13, 124}, Score{16, 121}, Score{42, 127}, Score{54, 130}, Score{69, 132},
		Score{79, 136}, Score{91, 132}, Score{200, 97}},
	{Score{-39, -36}, Score{-21, -15}, Score{-25, 0}, Score{-46, -4}, Score{-27, -1}, Score{-7, -47}, // Queens
		Score{-3, -19}, Score{21, -2}, Score{32, 34}, Score{44, 20}, Score{49, 58}, Score{50, 78},
		Score{56, 69}, Score{61, 110}, Score{61, 116}, Score{65, 125}, Score{68, 129}, Score{58, 135},
		Score{98, 114}, Score{85, 148}, Score{101, 144}, Score{122, 124}, Score{127, 109}, Score{139, 97},
		Score{107, 91}, Score{67, 92}, Score{4, 0}, Score{39, 63}},
}
...
var passedFile = [8]Score{Score{-32, 54}, Score{-72, 55}, Score{-60, 22}, Score{-62, -1},
...
var pawnShieldBonus = [...]Score{Score{11, 0}, Score{-12, 0}} // score for every pawn
