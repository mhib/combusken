...
var KnightValue = S(508, 436)
var BishopValue = S(461, 432)
var RookValue = S(656, 691)
var QueenValue = S(1452, 1323)

// Piece Square Values
var PieceScores = [King + 1][8][4]Score{
	{},
	{ // knight
		{S(-53, -44), S(-10, -54), S(-40, -35), S(-13, -25)},
		{S(-17, -56), S(-19, -38), S(-10, -32), S(-4, -22)},
		{S(-9, -40), S(1, -31), S(0, -22), S(3, -3)},
		{S(-12, -28), S(13, -25), S(9, -1), S(3, 4)},
		{S(-4, -35), S(3, -21), S(6, 1), S(19, 3)},
		{S(-35, -51), S(16, -43), S(-19, 1), S(3, 0)},
		{S(-83, -50), S(-49, -25), S(44, -49), S(0, -20)},
		{S(-198, -72), S(-75, -74), S(-127, -22), S(1, -54)},
	},
	{ // Bishop
		{S(-15, -24), S(14, -8), S(15, -11), S(12, -5)},
		{S(12, -30), S(34, -41), S(26, -13), S(14, -7)},
		{S(15, -21), S(35, -11), S(17, -12), S(17, 7)},
		{S(-4, -24), S(5, -17), S(12, -4), S(22, 2)},
		{S(-24, -15), S(-1, -17), S(-8, -1), S(18, 4)},
		{S(-40, -9), S(-16, -15), S(-34, -12), S(-20, -6)},
		{S(-61, 0), S(-31, -12), S(-14, 5), S(-5, -10)},
		{S(-31, -35), S(-30, -16), S(-114, 1), S(-90, 0)},
	},
	{ // Rook
		{S(-7, -17), S(-11, -5), S(10, -15), S(10, -15)},
		{S(-41, 0), S(-3, -18), S(-1, -15), S(4, -14)},
		{S(-35, -8), S(-13, -8), S(-2, -17), S(-11, -13)},
		{S(-39, 5), S(-9, -3), S(-13, 1), S(-11, -2)},
		{S(-38, 10), S(-21, 3), S(10, 7), S(-3, 1)},
		{S(-25, 4), S(16, 0), S(13, -2), S(-5, 3)},
		{S(-3, 14), S(7, 14), S(48, 2), S(55, -7)},
		{S(-2, 13), S(12, 10), S(-21, 18), S(23, 9)},
	},
	{ // Queen
		{S(0, -58), S(16, -73), S(16, -60), S(29, -68)},
		{S(-3, -39), S(7, -50), S(27, -55), S(26, -45)},
		{S(-6, -14), S(17, -31), S(-4, 6), S(4, -6)},
		{S(-2, -19), S(-23, 34), S(-7, 18), S(-16, 40)},
		{S(-21, 12), S(-28, 31), S(-28, 31), S(-25, 47)},
		{S(16, -27), S(4, -8), S(20, -3), S(-1, 41)},
		{S(-9, -24), S(-55, 16), S(-11, 21), S(-43, 51)},
		{S(7, -22), S(7, -1), S(17, 6), S(19, 14)},
	},
	{ // King
		{S(187, -17), S(161, 23), S(76, 73), S(83, 58)},
		{S(173, 23), S(139, 45), S(70, 82), S(34, 94)},
		{S(83, 48), S(108, 58), S(54, 85), S(39, 94)},
		{S(20, 47), S(96, 51), S(30, 91), S(-2, 101)},
		{S(28, 57), S(110, 71), S(68, 93), S(83, 88)},
		{S(90, 64), S(237, 66), S(224, 81), S(160, 64)},
		{S(44, 65), S(119, 77), S(108, 98), S(165, 71)},
		{S(32, 10), S(128, 36), S(115, 68), S(27, 53)},
	},
}
...
var PawnScores = [7][8]Score{
	{},
	{S(-18, 9), S(11, 0), S(-10, 13), S(11, 6), S(3, 15), S(17, 6), S(32, 0), S(-2, -2)},
	{S(-13, -6), S(-17, -2), S(4, -5), S(6, 2), S(4, -3), S(1, 5), S(9, -5), S(-8, -5)},
	{S(-15, 4), S(-17, 4), S(14, -7), S(23, -9), S(26, -6), S(4, -2), S(-2, 3), S(-19, 3)},
	{S(-6, 15), S(24, -4), S(10, -3), S(34, -15), S(37, -16), S(20, 0), S(36, 5), S(-8, 16)},
	{S(11, 43), S(14, 34), S(53, 13), S(47, 0), S(90, -15), S(93, -2), S(56, 21), S(10, 42)},
	{S(-3, 57), S(69, 38), S(-12, 45), S(18, 34), S(49, 42), S(67, 28), S(-35, 66), S(-117, 105)},
}

var PawnsConnected = [7][4]Score{
	{S(0, 0), S(0, 0), S(0, 0), S(0, 0)},
	{S(9, -21), S(8, 5), S(5, -8), S(4, 19)},
	{S(11, 0), S(32, 3), S(13, 7), S(16, 19)},
	{S(10, 9), S(29, 5), S(19, 12), S(19, 13)},
	{S(15, 17), S(9, 26), S(29, 22), S(31, 23)},
	{S(16, 58), S(39, 59), S(57, 60), S(61, 46)},
	{S(202, 7), S(151, -17), S(203, -10), S(352, 10)},
}

var MobilityBonus = [...][32]Score{
	{S(-43, -118), S(-31, -67), S(-21, -39), S(-19, -20), S(-5, -19), S(5, -9), // Knights
		S(14, -11), S(26, -15), S(35, -23)},
	{S(-26, -73), S(-7, -58), S(11, -28), S(18, -9), S(28, 1), S(38, 6), // Bishops
		S(44, 10), S(47, 12), S(49, 15), S(52, 14), S(68, 0), S(91, 4),
		S(49, 22), S(80, 10)},
	{S(-61, -35), S(-33, -30), S(-16, 6), S(-6, 36), S(4, 45), S(8, 56), // Rooks
		S(11, 66), S(21, 65), S(23, 64), S(36, 68), S(44, 67), S(45, 72),
		S(50, 75), S(62, 73), S(89, 61)},
	{S(-1430, -20), S(-178, -205), S(6, -268), S(-6, -180), S(-3, -20), S(3, -23), // Queens
		S(2, -21), S(11, -4), S(14, 20), S(18, 22), S(18, 39), S(19, 48),
		S(27, 37), S(25, 65), S(27, 64), S(28, 71), S(31, 69), S(27, 72),
		S(37, 63), S(45, 72), S(66, 47), S(49, 55), S(69, 38), S(63, 25),
		S(95, -4), S(29, 18), S(-8, -9), S(20, -42)},
}

var PassedFriendlyDistance = [8]Score{
	S(0, 0), S(-1, 30), S(-4, 12), S(-7, -11),
	S(-9, -20), S(-16, -24), S(7, -28), S(-29, -15),
}

var PassedEnemyDistance = [8]Score{
	S(0, 0), S(-42, -58), S(28, -31), S(12, 7),
	S(8, 28), S(5, 36), S(5, 39), S(-12, 48),
}
...
var PassedRank = [7]Score{S(0, 0), S(-4, -33), S(-5, -16), S(-2, 24), S(21, 74), S(31, 164), S(124, 255)}
...
var PassedStacked = [8]Score{S(0, 0), S(-15, -38), S(-5, -38), S(-24, -41), S(-65, -38), S(5, -78), S(0, 0), S(0, 0)}
...
var KnightOutpostUndefendedBonus = S(33, -15)
var KnightOutpostDefendedBonus = S(54, 15)

var DistantKnight = [4]Score{S(-18, 13), S(-22, 2), S(-34, 15), S(-82, -9)}
...
var KingDefenders = [12]Score{
	...
	S(8, -5), S(20, -7), S(29, 0), S(36, 0),
	S(44, -33), S(40, -2), S(1420, 0), S(11, 0),
}

var KingShelter = [2][8][8]Score{
	{{S(-38, 2), S(-6, -9), S(-8, 7), S(36, -7),
		S(7, -18), S(3, 0), S(5, -14), S(-30, 12)},
		{S(21, -1), S(33, -15), S(2, -3), S(-2, 6),
			S(-24, -6), S(9, -12), S(23, -40), S(-33, 6)},
		{S(12, 6), S(1, 1), S(-19, 3), S(-20, 8),
			S(-34, 0), S(-15, 1), S(-3, -7), S(-17, -2)},
		{S(-15, 21), S(6, 7), S(-6, -4), S(5, -2),
			S(10, -22), S(-1, -14), S(10, -41), S(-21, 1)},
		{S(-1, 7), S(-1, 2), S(-20, -1), S(-24, 8),
			S(-14, -8), S(-22, 2), S(-23, -9), S(-25, 4)},
		{S(43, -9), S(22, -15), S(-1, -10), S(4, -9),
			S(9, -22), S(0, -4), S(31, -26), S(-11, 1)},
		{S(25, -2), S(-4, -4), S(-20, -8), S(-8, -3),
			S(-12, -8), S(11, -5), S(6, -22), S(-33, 14)},
		{S(-21, 1), S(-28, 0), S(-10, 7), S(-16, 12),
			S(-6, 8), S(-19, 19), S(-37, 8), S(-59, 36)}},
	{{S(-1, -4), S(-43, -17), S(-18, -5), S(-81, -20),
		S(0, -11), S(-31, -13), S(-77, 2), S(-67, 19)},
		{S(10, 51), S(2, -15), S(-21, -1), S(-5, -3),
			S(-4, 2), S(21, -42), S(10, -15), S(-66, 21)},
		{S(20, 27), S(42, -5), S(12, -8), S(10, -9),
			S(17, 1), S(-15, -8), S(59, -17), S(-30, 6)},
		{S(9, 24), S(-34, 19), S(-14, 11), S(-21, 4),
			S(-20, 22), S(-88, 36), S(-20, -1), S(-44, 5)},
		{S(8, 45), S(2, 4), S(-4, 0), S(-10, -1),
			S(-9, 7), S(-1, -10), S(-1, -14), S(-37, 6)},
		{S(69, -18), S(21, -12), S(-6, 2), S(2, -13),
			S(-4, -7), S(-11, -16), S(17, -28), S(-31, 4)},
		{S(0, 11), S(9, -16), S(1, -15), S(-20, -8),
			S(-17, -11), S(-3, -16), S(3, -18), S(-68, 20)},
		{S(3, -8), S(-5, -26), S(-4, -13), S(-21, -8),
			S(-22, -4), S(10, -7), S(-27, -24), S(-64, 26)}},
}

var KingStorm = [2][4][8]Score{
	{{S(19, 0), S(12, -1), S(16, 0), S(-2, 10),
		S(0, 12), S(9, 11), S(0, 17), S(5, -12)},
		{S(14, 2), S(11, 3), S(24, 0), S(3, 8),
			S(10, 5), S(15, 0), S(6, -1), S(2, -12)},
		{S(15, 13), S(11, 8), S(1, 14), S(-9, 17),
			S(-3, 12), S(5, 3), S(20, -16), S(9, -5)},
		{S(15, 10), S(3, 3), S(5, 1), S(-4, 5),
			S(-7, 11), S(5, 9), S(2, 7), S(-5, 1)}},
	{{S(0, 0), S(8, 16), S(-9, 8), S(21, -4),
		S(15, 11), S(-9, 15), S(11, 48), S(15, -22)},
		{S(0, 0), S(10, -29), S(-4, -2), S(58, -11),
			S(50, -17), S(-20, 1), S(-29, 34), S(2, -20)},
		{S(0, 0), S(-71, -1), S(-1, -2), S(16, 3),
			S(0, 0), S(-4, -11), S(72, -50), S(8, -2)},
		{S(0, 0), S(0, -17), S(13, -17), S(-8, 1),
			S(-6, 1), S(6, -25), S(-24, 11), S(-6, 16)}},
}
...
var KingSafetyAttacksWeights = [King + 1]int16{0, -3, -4, -2, 0, 0}
...
var KingSafetySafeBishopCheck int16 = 92
var KingSafetySafeKnightCheck int16 = 121
var KingSafetyAdjustment int16 = -37

var Hanging = S(49, 15)
var ThreatByKing = S(19, 42)
var ThreatByMinor = [King + 1]Score{S(0, 0), S(23, 32), S(28, 35), S(72, 23), S(58, 13), S(139, 49)}
var ThreatByRook = [King + 1]Score{S(0, 0), S(4, 16), S(3, 29), S(-14, 22), S(91, 0), S(180, 28)}
