...
var PieceScores = [King + 1][8][4]Score{
	...
	{ // King
		{S(182, -44), S(141, 29), S(55, 68), S(57, 96)},
		{S(175, 13), S(134, 38), S(54, 75), S(33, 138)},
		{S(115, 21), S(151, 34), S(112, 65), S(96, 137)},
		{S(82, 24), S(227, 32), S(156, 72), S(97, 148)},
		{S(82, 51), S(224, 53), S(151, 88), S(105, 141)},
		{S(47, 60), S(237, 71), S(234, 77), S(175, 116)},
		{S(10, 30), S(127, 82), S(152, 79), S(149, 107)},
		{S(0, -33), S(155, 26), S(110, 44), S(32, 103)},
	},
}
...
var KingOnPawnlessFlank = S(19, -64)
...
var KingSafetyAttacksWeights = [King + 1]int16{0, 0, -4, -2, 6, 0}
var KingSafetyAttackValue int16 = 115
var KingSafetyWeakSquares int16 = 38
var KingSafetyFriendlyPawns int16 = -15
var KingSafetyNoEnemyQueens int16 = -93
var KingSafetySafeQueenCheck int16 = 78
var KingSafetySafeRookCheck int16 = 56
var KingSafetySafeBishopCheck int16 = 50
var KingSafetySafeKnightCheck int16 = 89
var KingSafetyAdjustment int16 = -6
var KingSafetyMiddleDivisor int16 = 719
var KingSafetyEndDivisor int16 = 16
