...
var PawnValue = S(100, 119)
var KnightValue = S(511, 435)
var BishopValue = S(466, 432)
var RookValue = S(662, 690)
...
var PieceScores = [King + 1][8][4]Score{
	{},
	{ // knight
		{S(-59, -40), S(-19, -54), S(-40, -35), S(-13, -24)},
		{S(-18, -56), S(-25, -37), S(-10, -31), S(-4, -20)},
		{S(-11, -39), S(1, -31), S(8, -25), S(6, -4)},
		{S(-14, -28), S(14, -25), S(6, -1), S(2, 3)},
		{S(-2, -32), S(-1, -21), S(12, 0), S(20, 3)},
		{S(-37, -51), S(22, -43), S(-52, -1), S(27, -6)},
		{S(-76, -49), S(-42, -27), S(54, -53), S(-2, -21)},
		{S(-210, -69), S(-76, -73), S(-127, -30), S(1, -55)},
	},
	{ // Bishop
		{S(-9, -11), S(6, -4), S(5, -14), S(7, -4)},
		{S(3, -25), S(44, -31), S(29, -15), S(17, -10)},
		{S(13, -18), S(35, -9), S(34, -3), S(19, 11)},
		{S(0, -23), S(5, -19), S(11, -2), S(26, 0)},
		{S(-21, -13), S(-1, -17), S(-2, -1), S(25, 0)},
		{S(-61, -2), S(-16, -13), S(-37, 4), S(-18, -8)},
		{S(-75, 2), S(20, -9), S(-14, 2), S(2, -14)},
		{S(-1, -28), S(-36, -19), S(-113, -5), S(-92, -4)},
	},
	{ // Rook
		{S(-6, -18), S(-11, -5), S(11, -12), S(16, -18)},
		{S(-47, 0), S(-5, -18), S(-6, -14), S(4, -15)},
		{S(-37, -8), S(-14, -7), S(-3, -16), S(-11, -14)},
		{S(-40, 3), S(-10, -3), S(-16, 1), S(-12, -1)},
		{S(-38, 9), S(-23, 3), S(11, 8), S(-6, 2)},
		{S(-25, 4), S(16, 1), S(20, -2), S(-8, 3)},
		{S(7, 10), S(5, 15), S(48, 2), S(60, -8)},
		{S(6, 11), S(8, 10), S(-21, 17), S(14, 11)},
	},
	{ // Queen
		{S(0, -58), S(16, -72), S(16, -60), S(34, -67)},
		{S(-3, -41), S(7, -50), S(27, -56), S(34, -44)},
		{S(-6, -14), S(15, -30), S(-2, 5), S(4, -6)},
		{S(-3, -18), S(-25, 34), S(-6, 18), S(-18, 44)},
		{S(-22, 12), S(-28, 27), S(-29, 31), S(-32, 51)},
		{S(20, -26), S(3, -8), S(-4, 13), S(-8, 45)},
		{S(-9, -24), S(-54, 17), S(-19, 21), S(-35, 52)},
		{S(8, -20), S(2, 0), S(17, 6), S(19, 14)},
	},
	{ // King
		{S(185, -14), S(161, 25), S(76, 74), S(79, 65)},
		{S(169, 27), S(133, 49), S(68, 83), S(35, 95)},
		{S(82, 49), S(108, 60), S(43, 89), S(39, 96)},
		{S(14, 49), S(72, 58), S(30, 92), S(-3, 101)},
		{S(25, 60), S(102, 76), S(63, 96), S(85, 87)},
...
var PawnScores = [7][8]Score{
	{},
	{S(-24, 10), S(7, -1), S(-9, 12), S(13, 6), S(5, 15), S(19, 5), S(30, -1), S(-5, 0)},
	{S(-12, -3), S(-20, -1), S(6, -7), S(9, 1), S(5, -2), S(3, 4), S(10, -7), S(-7, -2)},
	{S(-13, 4), S(-17, 3), S(18, -9), S(24, -8), S(30, -10), S(5, -1), S(2, 0), S(-19, 6)},
	{S(-3, 16), S(23, 1), S(11, -5), S(38, -13), S(39, -14), S(18, 0), S(38, 2), S(-3, 15)},
	{S(11, 42), S(23, 30), S(53, 13), S(47, 1), S(90, -12), S(94, -3), S(56, 20), S(9, 44)},
...
var MobilityBonus = [...][32]Score{
	{S(-42, -117), S(-31, -67), S(-18, -40), S(-15, -23), S(0, -21), S(7, -19), // Knights
		S(15, -15), S(20, -10), S(35, -25)},
	{S(-21, -73), S(-4, -59), S(16, -29), S(20, -9), S(31, -3), S(40, 7), // Bishops
		S(42, 10), S(47, 12), S(47, 15), S(47, 14), S(66, 2), S(91, 1),
		S(50, 23), S(66, 8)},
	{S(-39, -35), S(-11, -28), S(1, 13), S(7, 35), S(12, 43), S(11, 57), // Rooks
		S(16, 63), S(21, 64), S(29, 65), S(37, 66), S(38, 69), S(45, 73),
		S(51, 72), S(62, 71), S(92, 59)},
	{S(-22, -20), S(-48, -8), S(-4, -141), S(-3, -118), S(-2, -19), S(-2, -23), // Queens
		S(6, -21), S(7, -5), S(12, 19), S(16, 22), S(14, 36), S(17, 46),
		S(26, 36), S(21, 60), S(28, 63), S(28, 75), S(31, 69), S(26, 71),
